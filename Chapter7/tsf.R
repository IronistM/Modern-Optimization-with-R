...
# note: the book results were achieved with rgp package version 0.3-4
#       and current rgp package (0.4-0) produces slightly different results 
#       (I got "gp fit MAE= 13.96245" after updating the rgp package)
